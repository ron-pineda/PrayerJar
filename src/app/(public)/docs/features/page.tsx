...
const FEATURES: FeatureCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Church prayer wall (coming soon)', desc: 'The wall page is built and members-only, but a prayer is not attached to a church when it is submitted, so the wall stays empty on every plan.' },
      ...
      { name: 'Analytics', desc: 'Member growth reports real numbers on screen in the church dashboard.' },
