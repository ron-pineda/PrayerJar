...
export const verses: Verse[] = [
  ...
  { text: 'Thou shalt keep him in perfect peace, whose mind is stayed on thee.', reference: 'Isaiah 26:3' },
  ...
  { text: 'These things I have spoken unto you, that in me ye might have peace. In the world ye shall have tribulation.', reference: 'John 16:33' },
  ...
  { text: 'For God did not give us a spirit of timidity, but a spirit of power, of love and of self-discipline.', reference: '2 Timothy 1:7' },
  ...
  { text: 'But blessed is the man who trusts in the Lord, whose confidence is in him.', reference: 'Jeremiah 17:7' },
  ...
  { text: 'Therefore, if anyone is in Christ, he is a new creation; old things have passed away.', reference: '2 Corinthians 5:17' },
  { text: 'I know the thoughts that I think toward you, thoughts of peace and not of evil.', reference: 'Jeremiah 29:11' },
  { text: 'May your unfailing love rest upon us, O Lord, even as we put our hope in you.', reference: 'Psalm 33:22' },
  { text: 'The Lord is my light and my salvation whom shall I fear? The Lord is the stronghold of my life.', reference: 'Psalm 27:1' },
  ...
  { text: 'Praise ye the Lord. Blessed is the man that feareth the Lord, that delighteth greatly in his commandments.', reference: 'Psalm 112:1' },
  ...
  { text: 'Do not conform to the pattern of this world, but be transformed by the renewing of your mind.', reference: 'Romans 12:2' },
  { text: 'Then you will be able to test and approve what God\'s will is—his good, pleasing and perfect will.', reference: 'Romans 12:2' },
  ...
  { text: 'If your gift is prophesying, then prophesy in accordance with your faith.', reference: 'Romans 12:6' },
  ...
  { text: 'Do not be conceited.', reference: 'Romans 12:16' },
  ...
  { text: 'The Lord upholds all those who fall and lifts up all who are bowed down.', reference: 'Psalm 145:14' },
  ...
  { text: 'The Lord is righteous in all his ways and loving toward all he has made.', reference: 'Psalm 145:17' },
...
export function getDayVerse(date: Date = new Date()): Verse {
  if (verses.length === 0) {
    return {
